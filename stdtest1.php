...
<html>
    ...
    <body >
        ...
        <div id="container">
            ...
            <form id="stdtest" action="stdtest1.php" method="post">
                <div class="menubar">
                    <ul id="menu">
                        <?php
                        if (isset($_SESSION['stdname'])) {
                    ...
                    ?>
                        ...
                        <?php
                                    while ($r = mysql_fetch_array($result)) {
                                        ...
                                        . "<td class=\"tddata\"><a title=\"Start Test\" href=\"stdtest1.php?testcode=" . htmlspecialchars_decode($r['testname'], ENT_QUOTES) . "\"><img src=\"images/starttest.png\" height=\"30\" width=\"40\" alt=\"Start Test\" /></a></td></tr>";
                                    }
                        ?>
                                </table>
                    <?php
